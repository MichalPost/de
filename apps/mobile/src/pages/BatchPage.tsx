...
import { Button } from '@chemtools/shared/ui/Field'
...
import { useCopyAsync } from '@chemtools/shared/ui/CopyButton'
import { useToast } from '@chemtools/shared/ui/Toast'
import { useTemplateStore } from '@chemtools/shared/store/templateStore'
import { useBatchStore } from '@chemtools/shared/store/batchStore'
...
function ResultPanel({ records, currentPageRecords, viewMode, printMode, printCols, printPerPage,
  ...
  currentPageRecords: import('../features/batch/types').BatchGeneratedRecord[]
  viewMode: ViewMode; printMode: PrintMode
